  ...
  return (
    <div>
      <input
        ref={ref}
        {...props}
        className={`appearance-none rounded px-4 py-3 placeholder:text-neutral-charcoal border focus:border-2 focus:outline-none h-12 text-sm md:text-base w-full ${className} ${
          error
